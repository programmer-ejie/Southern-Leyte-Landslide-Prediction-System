...
import ProfilePage from './admin/profile.jsx'
import AccountsPage from './admin/accounts.jsx'
...
const ADMIN_ONLY_PATHS = [ACCOUNTS_PATH]
...
function resolvePath(pathName: string) {
  ...
  const sessionPayload = getValidSessionPayload()
  ...
  if (ADMIN_ONLY_PATHS.includes(pathName) && sessionPayload.role !== 'admin') {
    window.history.replaceState(null, '', DASHBOARD_PATH)
    return DASHBOARD_PATH
  }
